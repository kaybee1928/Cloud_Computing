...
def add_user():
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'add_user', 'username':username})
	if (response.json())['user_exists']:
		print({"error":"user already exists"})
		return jsonify({"error":"user already exists"}), 400

	# Insert the user into the database
	response = requests.post(url='http://localhost:5000/api/v1/db/write', json={'api':'add_user', 'username':username, 'password':password})
	print("success")
...
def delete_user(username):
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'delete_user', 'username':username})
	if not (response.json())['user_exists']:
		print({'error':'user not in database'})
		return jsonify({'error':'user not in database'}), 400

	# Remove the user from the database
	response = requests.post(url='http://localhost:5000/api/v1/db/write', json={'api':'delete_user', 'username':username})
	print("success")
...
def new_ride():
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'new_ride', 'username':created_by, 'source':source, 'destination':destination})
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/write', json={'api':'new_ride', 'created_by':created_by, 'timestamp':timestamp, 'source':source, 'destination':destination})
	print("success")
	return jsonify(response.json()), 201
...
def list_rides():
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'list_rides', 'source':source, 'destination':destination})
...
def get_ride_details(rideId):
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'get_ride_details', 'rideId':rideId})
...
def join_ride(rideId):
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'join_ride', 'username':username, 'rideId':rideId})
	if not (response.json())['user_exists']:
		print({'error':'user not in database'})
		return jsonify({'error':'user not in database'}), 400
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/write', json={'api':'join_ride', 'username':username, 'rideId':rideId})
	print("success")
	return jsonify(response.json()), 201
...
def delete_ride(rideId):
	...
	response = requests.post(url='http://localhost:5000/api/v1/db/read', json={'api':'delete_ride', 'rideId':rideId})
	if not (response.json())['rideId_exists']:
		print({'error':'rideId not in the database'})
		return jsonify({'error':'rideId not in the database'}), 400

	# Remove ride from the database
	response = requests.post(url='http://localhost:5000/api/v1/db/write', json={'api':'delete_ride', 'rideId':rideId})
	print("success")
	return jsonify(response.json()), 200
