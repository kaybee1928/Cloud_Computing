...
def new_ride():
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/read', json={'api':'new_ride', 'username':created_by, 'source':source, 'destination':destination})
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/write', json={'api':'new_ride', 'created_by':created_by, 'timestamp':timestamp, 'source':source, 'destination':destination})
...
def list_rides():
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/read', json={'api':'list_rides', 'source':source, 'destination':destination})
...
def get_ride_details(rideId):
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/read', json={'api':'get_ride_details', 'rideId':rideId})
...
def join_ride(rideId):
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/read', json={'api':'join_ride', 'username':username, 'rideId':rideId})
	if not (response.json())['user_exists']:
		return jsonify({'error':'user not in database'}), 400
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/write', json={'api':'join_ride', 'username':username, 'rideId':rideId})
	return jsonify(response.json()), 201
...
def delete_ride(rideId):
	...
	response = requests.post(url='http://localhost:8000/api/v1/db/read', json={'api':'delete_ride', 'rideId':rideId})
	if not (response.json())['rideId_exists']:
		return jsonify({'error':'rideId not in the database'}), 400

	# Remove ride from the database
	response = requests.post(url='http://localhost:8000/api/v1/db/write', json={'api':'delete_ride', 'rideId':rideId})
	return jsonify(response.json()), 200
...
def db_clear():
	...
	requests.post(url='http://localhost:8000/api/v1/db/write', json={'api':'db_clear'})
...
def db_read():
	...
	if data['api'] == 'new_ride':
		...
		response = requests.get(url='http://172.17.0.1:8080/api/v1/users')
